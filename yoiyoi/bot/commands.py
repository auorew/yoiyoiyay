...
async def command_ignore_fw(update: Update, _: CallbackContext) -> None:
...
async def command_delete_link(update: Update, _: CallbackContext) -> None:
...
async def command_tiktok_style(update: Update, context: CallbackContext) -> None:
...
async def command_youtube_short_style(update: Update, context: CallbackContext) -> None:
...
async def command_tiktok_mode(update: Update, context: CallbackContext) -> None:
...
async def channel_commands(update: Update, context: CallbackContext) -> None:
